...
{
    if ($image === null) {
        return _ASSETS_IMG_PATCH_ . 'recipe_default.jpg';
    } else {
        return _RECIPES_IMG_PATCH_ . $image;
    }
}
...
function saveRecipe(PDO $pdo, int $category, string $title, string $description, string $instructions, string $ingredients, string|null $image)
{
